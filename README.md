# BÁO CÁO PHÂN TÍCH HIỆU SUẤT KINH DOANH: 50/50 COFFEE & TEA

## 0. GIỚI THIỆU VỀ BỘ DỮ LIỆU (DATASET OVERVIEW)

Báo cáo này được xây dựng dựa trên kết quả phân tích dữ liệu bán hàng thực tế của hệ thống **50/50 Coffee & Tea**, nhằm cung cấp cái nhìn toàn diện về tình hình kinh doanh và hành vi khách hàng.
...
![Biểu đồ Top 10 Sản phẩm Bán chạy nhất](bán chạyythoe số lượng.png)
![Chi tiết doanh thu theo từng món](Bán chạy theo doanh thu.png)
...
![Biểu đồ Tỷ trọng Doanh thu theo Danh mục](5 mục bán chạyynhaats theo doanh thu.png)
...
![Biểu đồ Xu hướng Doanh thu theo Tháng](xu hướng hàng tháng.png)
...
![Biểu đồ Phân bổ Doanh thu theo Thứ trong Tuần](hiệu suất bán hàng ngày trong tuần.png)
...
![Biểu đồ Tỷ lệ Phương thức Thanh toán](Phương thức thanh toán phổ biến.png)
![Biểu đồ Nguồn đơn hàng](Nguồn hàng phổ biến.png)
